...
CREATE DATABASE IF NOT EXISTS `clinica` DEFAULT CHARACTER SET utf8mb4;
USE `clinica`;
...
(4, 'Gomez', 'Marcos', '1975-08-01', '$2b$10$hashdeejemplo4', 'administrador', 'mgomez@clinica.com', '3424222333', '18222333', NULL, NULL);
